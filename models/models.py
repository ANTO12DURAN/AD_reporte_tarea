...
class ReporteTarea(models.Model):
    ...
    actividad_ids = fields.One2many('reporte.actividad', inverse_name='reportetarea_id', string="Actividades", )


#    formulacion_ids = fields.One2many('reporte.formulacion', inverse_name='reportetarea_id', string='Formulacion', )
...
class responsable(models.Model):
    ...
    actividad_ids = fields.One2many('reporte.actividad', inverse_name='responsable_id', string='Actividad')
...
class TipoActividad(models.Model):
    ...
    name = fields.Char(string="Tipo Actividad", )
    description = fields.Char(string="description", )
    actividad_ids = fields.One2many('reporte.actividad', inverse_name='tipoactividad_id', string='Tarea/actividades')
...
class Actividad(models.Model):
    ...
    responsable_id = fields.Many2one(comodel_name="reporte.responsable", string="Responsable", )
    reportetarea_id = fields.Many2one(comodel_name="reporte.tarea", string="Tarea" )
